...
//Модальное окно cart-overlay"> <!-- cart-overlay-open 
...
try {
    ...
    const createCard = ({ id, preview, cost, brand, name, sizes}) => { //type 3

        // const { id, preview, cost, brand, name, sizes} = data;     type 2
        // // const id = data.id;
        // const preview = data.preview;
        // const cost = data.cost;                 type 1
